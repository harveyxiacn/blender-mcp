...
class CharacterTemplateInput(BaseModel):
    ...
    template: str = Field(
        default="chibi", description="Template type: chibi, realistic, anime, stylized, mascot"
    )
    ...
    skin_color: list[float] | None = Field(default=None, description="Skin color RGBA")
...
class HairCreateInput(BaseModel):
    ...
    color: list[float] | None = Field(default=None, description="Hair color RGBA")
