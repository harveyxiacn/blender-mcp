...
def setup(obj, mat_name, col_name='Characters', ss=2, outline=0.003):
...
bpy.ops.mesh.primitive_uv_sphere_add(segments=28, ring_count=18, radius=0.108, location=(sx, 0, 1.54))
...
for side, sgn in (('L', 1), ('R', -1)):
    bpy.ops.mesh.primitive_uv_sphere_add(segments=14, ring_count=10, radius=0.028, location=(sx + sgn * 0.036, -0.086, 1.545))
    ...
    bpy.ops.mesh.primitive_uv_sphere_add(segments=12, ring_count=8, radius=0.020, location=(sx + sgn * 0.036, -0.100, 1.542))
    ...
    bpy.ops.mesh.primitive_uv_sphere_add(segments=8, ring_count=6, radius=0.008, location=(sx + sgn * 0.036, -0.112, 1.541))
    ...
    bpy.ops.mesh.primitive_uv_sphere_add(segments=8, ring_count=6, radius=0.007, location=(sx + sgn * 0.045, -0.116, 1.557))
...
bpy.ops.mesh.primitive_uv_sphere_add(segments=8, ring_count=6, radius=0.006, location=(sx, -0.108, 1.514))
...
bpy.ops.mesh.primitive_uv_sphere_add(segments=20, ring_count=14, radius=0.120, location=(sx, 0.008, 1.59))
...
for side, sgn in (('L', 1), ('R', -1)):
    ...
    bpy.ops.mesh.primitive_uv_sphere_add(segments=10, ring_count=8, radius=0.021, location=(sx + sgn * 0.24, 0.0, 0.86))
