"""Run rigged-model pipeline through Blender MCP socket."""
...
PIPELINE = [
    ...
    ("build_rigged_models.py", "Merge + Rig + Animate"),
]
...
'''
    ...
    if resp.get("success"):
        ...
        return True, output
    return False, resp.get("error", {}).get("message", "Unknown error")
...
def main() -> int:
    ...
    print("\n[OK] Rigged pipeline completed.")
    print("Blend  : E:\\Projects\\blender-mcp\\examples\\sao_kirito_asuna_rigged.blend")
    print("Preview: E:\\Projects\\blender-mcp\\examples\\sao_kirito_asuna_rigged_preview.png")
    return 0
