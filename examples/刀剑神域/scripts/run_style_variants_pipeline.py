"""Run base Kirito/Asuna pipeline + multi-style variants through Blender MCP."""
...
PIPELINE = [
    ...
    ("create_style_variants.py", "Create TV + Figure Styles"),
]
...
def main() -> int:
    ...
    print("\n[OK] Style pipeline completed.")
    print("Action blend: E:\\Projects\\blender-mcp\\examples\\sao_kirito_asuna_action.blend")
    print("TV style blend: E:\\Projects\\blender-mcp\\examples\\sao_style_tv.blend")
    print("Figure style blend: E:\\Projects\\blender-mcp\\examples\\sao_style_figure.blend")
    print("TV preview : E:\\Projects\\blender-mcp\\examples\\sao_style_tv_poster.png")
    print("Figure preview: E:\\Projects\\blender-mcp\\examples\\sao_style_figure_display.png")
    return 0
