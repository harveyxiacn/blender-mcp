...
BLOCKED_PATTERNS = [
    ...
    "__import__('subprocess", "__import__('socket",
    "__import__('os').system", "__import__('shutil').rmtree",
...
def handle_execute_python(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not code or not code.strip():
        return {
            "success": False,
            "error": {"code": "EMPTY_CODE", "message": "Code is empty"}
        }
